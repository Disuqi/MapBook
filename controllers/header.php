...
if(isset($_SESSION['loggedIn']) && $_SESSION['loggedIn']){
    $view->signInBtn = '
                        <div class="d-flex justify-content-end">
                            <div class="dropdown">
                              <button class="btn friendR" type="button" data-bs-toggle="dropdown" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
